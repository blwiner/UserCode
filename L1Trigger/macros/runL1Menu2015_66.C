...
//  InstLumi                  Instantaneous luminosity (used if no lsFile) Given in units of e32.
...
// Define the input parameters
   TString L1MenuFile           = "upgrade/L1Menu_v1_std.txt";
	std::string InputRootFileName= "/obsidian/users/winer/cms/L1Trigger/Simulations/Bristol/8TeV/ZeroBiasHPF1/2012HPF_66_v1/Test2.root";
	TString lsFileName           = "upgrade/getLumi_out_66_stdCorr_v2.txt";
	Float_t ZeroBiasPrescale     = 92.;
	Float_t NumberOfLumiSections = 63.;
	Float_t InstLumi             = 0.1765;  //units of e32
	TString jobTag               = "test"; //"66PUData_std";		
	float targetLumi             = 200.; //units of e32  
	int  numEvts                 = -1; //Number of events to process (-1 == all in file)
   int  makeThrPlots            = 0;
	bool useL1Extra              = true;
   TString thresholdPlotsFile   = "L1RateHist_66PUDataThr1_rates.root"; //Set a default. If makeThrPlot != 0 it will be reset
